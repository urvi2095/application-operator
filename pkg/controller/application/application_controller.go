...
import (
	...
	applicationv2alpha2 "github.com/urvi2095/application-operator/pkg/apis/application/v2alpha2"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &applicationv2alpha2.Application{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &appsv1.Deployment{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &applicationv2alpha2.Application{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileApplication) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &applicationv2alpha2.Application{}
...
func newDeploymentCR(cr *applicationv2alpha2.Application) *appsv1.Deployment {
...
func updateDeploymentReplicas(cr *applicationv2alpha2.Application, deployment *appsv1.Deployment) bool {
	deployment.Spec.Replicas = int32Ptr(cr.Spec.Replicas)
	return true
}

func updateDeploymentAppVersion(cr *applicationv2alpha2.Application, deployment *appsv1.Deployment) bool {
	deployment.Spec.Template.Spec.Containers[0].Image = cr.Spec.ApplicationVersion
	return true
}

func updateApplicationStatus(cr *applicationv2alpha2.Application, deployment *appsv1.Deployment) bool {
